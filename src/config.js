  ...
  switch (transportType) {
    ...
    case 'daily': {
      ...
      if (!dailyRoom || !dailyToken) {
        console.error('❌ Missing dailyRoom or dailyToken:', responseData);
        throw new Error('Backend did not return dailyRoom or dailyToken');
      }
      
      console.log('🔧 Creating Daily transport with room:', dailyRoom);
      
      // ✅ Create transport with config object (per documentation)
    ...
    case 'smallwebrtc': {
      ...
      // ✅ For SmallWebRTC, pass body in the config
      ...
      console.log('🔧 SmallWebRTC transport config:', smallWebRTCConfigWithUserInfo);
